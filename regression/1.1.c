...
PRIVATE Objptr globalObjptr [12];
...
EndIntInfInits
BeginVectorInits
VectorInitElem ("control shouldn\'t reach here", 1, 7, 28)
VectorInitElem ("Overflow", 1, 9, 8)
VectorInitElem ("unhandled exception: ", 1, 8, 21)
VectorInitElem ("Top-level handler raised exception.\n", 1, 11, 36)
VectorInitElem ("unhandled exception in Basis Library", 1, 10, 36)
VectorInitElem ("\n", 1, 6, 1)
EndVectorInits
static void real_Init() {
}
static uint16_t frameOffsets0[] = {0};
static uint16_t frameOffsets1[] = {3,8,24,32};
static uint16_t frameOffsets2[] = {1,8};
static uint16_t frameOffsets3[] = {2,8,16};
static uint16_t frameOffsets4[] = {4,8,16,24,32};
static uint16_t frameOffsets5[] = {1,0};
static uint16_t frameOffsets6[] = {2,0,8};
static struct GC_frameLayout frameLayouts[] = {
	...
	{C_FRAME, frameOffsets5, 16},
	{C_FRAME, frameOffsets6, 40},
...
PRIVATE CPointer localCPointer[12];
...
PRIVATE Word32 localWord32[3];
PRIVATE Word64 localWord64[4];
MLtonMain (8, 0x5530B406, 48, TRUE, PROFILE_NONE, FALSE, F_0)
